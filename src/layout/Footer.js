      ...
      <div className="row justify-content-xl-between justify-content-center">
        <div className="col-xl-4 col-lg-5 col-md-6">
          <div className="footer-widget widget_about me-md-5 wow fadeInUp delay-0-2s">
            <div style={{ maxWidth: "60px" }} className="footer-logo mb-25">
              <Link href="/">
                <a>
                  <img
            ...
            <p>
              Nous ne sous-estimons jamais aucune partie de chaque projet,car
              elles sont toutes essentielles à l'atteinte de l'objectif
              final.Vous serez engagé grâce à notre attitude positive et
              enthousiaste.
            </p>
        ...
        <div className="col-xl-4 col-md-6">
          <div className="footer-widget widget_nav_menu wow fadeInUp delay-0-4s">
            <h4 className="footer-title">TÀGG</h4>
            <ul className="list-style-tw">
              <li>
        ...
        <div className="col-xl-4 col-lg-6 col-md-8">
          <div className="footer-widget widget_newsletter wow fadeInUp delay-0-6s">
            ...
            <form onSubmit={(e) => e.preventDefault()} action="#">
              ...
              S'abonner maintenant <i className="fas fa-angle-double-right" />
              </button>
            </form>
          </div>
        </div>
    ...
    <div className="footer-bottom mt-30 pt-25 pb-10">
      <div className="container">
        <div className="copyright-text text-center">
          <p>© Copyright 2023 TÀGG. Tous droits réservés</p>
        </div>
      </div>
    </div>
  </footer>
