    ...
    <header className="main-header">
                ...
                <div className="top-right text-center text-lg-end">
                  <ul>
                    <li>
                      ...
                      <a href="mailto:contact@taggue.com">contact@taggue.com</a>
                    </li>
                    <li>
                      <i className="far fa-phone" />{" "}
                      <a href="callto:+221780105426">+221 (78) 010 54 26</a>
                    </li>
                    <li>
      ...
      <div className="header-upper">
        <div className="container clearfix">
          ...
          >
            <div className="logo-outer">
              <div style={{ maxWidth: "100px" }} className="logo size-logo">
                <Link href="/">
                  <a>
                    <img
            ...
            <div className="nav-outer clearfix">
              <MobileMenu logo={"assets/images/logos/logo_dark.png"} />
              {/* Main Menu */}
              <nav className="main-menu d-none d-lg-block navbar-expand-lg">
                <div className="navbar-header">
                  <div className="mobile-logo my-15">
